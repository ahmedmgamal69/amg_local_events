...
const TextStyle whiteHeadingTextStyle = TextStyle(
    fontSize: 40.0, fontWeight: FontWeight.bold, color: Color(0xFFFFFFFF));

const TextStyle categoryTextStyle = TextStyle(
    fontSize: 14.0, fontWeight: FontWeight.bold, color: Color(0xFFFFFFFF));

TextStyle selectedCategoryTextStyle =
    categoryTextStyle.copyWith(color: const Color(0xFFFF4700));
...
const TextStyle eventWhiteTitleTextStyle = TextStyle(
    fontSize: 30.0, fontWeight: FontWeight.bold, color: Color(0xFFFFFFFF));

const TextStyle eventLocationTextStyle =
    TextStyle(fontSize: 20.0, color: Color(0xFF000000));

const TextStyle guestTextStyle = TextStyle(
    fontSize: 16.0, fontWeight: FontWeight.w800, color: Color(0xFF000000));

const TextStyle punchLine1TextStyle = TextStyle(
    fontSize: 20.0, fontWeight: FontWeight.w800, color: Color(0xFFFF4700));

TextStyle punchLine2TextStyle =
